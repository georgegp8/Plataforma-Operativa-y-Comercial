...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.documentos.driver' => 'string',
            'filesystems.disks.documentos.key' => 'string',
            'filesystems.disks.documentos.secret' => 'string',
            'filesystems.disks.documentos.region' => 'string',
            'filesystems.disks.documentos.bucket' => 'string',
            'filesystems.disks.documentos.url' => 'string',
            'filesystems.disks.documentos.endpoint' => 'string',
            'filesystems.disks.documentos.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.documentos.root' => 'string',
            'filesystems.disks.documentos.visibility' => 'string',
            'filesystems.disks.documentos.throw' => 'boolean',
            'filesystems.disks.comprobantes.driver' => 'string',
            'filesystems.disks.comprobantes.key' => 'string',
            'filesystems.disks.comprobantes.secret' => 'string',
            'filesystems.disks.comprobantes.region' => 'string',
            'filesystems.disks.comprobantes.bucket' => 'string',
            'filesystems.disks.comprobantes.url' => 'string',
            'filesystems.disks.comprobantes.endpoint' => 'string',
            'filesystems.disks.comprobantes.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.comprobantes.root' => 'string',
            'filesystems.disks.comprobantes.visibility' => 'string',
            'filesystems.disks.comprobantes.throw' => 'boolean',
            'filesystems.disks.adjuntos.driver' => 'string',
            'filesystems.disks.adjuntos.key' => 'string',
            'filesystems.disks.adjuntos.secret' => 'string',
            'filesystems.disks.adjuntos.region' => 'string',
            'filesystems.disks.adjuntos.bucket' => 'string',
            'filesystems.disks.adjuntos.url' => 'string',
            'filesystems.disks.adjuntos.endpoint' => 'string',
            'filesystems.disks.adjuntos.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.adjuntos.root' => 'string',
            'filesystems.disks.adjuntos.visibility' => 'string',
            'filesystems.disks.adjuntos.throw' => 'boolean',
            'filesystems.links.C:\Plataforma_Op_Com_Facturacion_Elect\backend\public\storage' => 'string',
            ...
            'logging.channels.nubefact.driver' => 'string',
            'logging.channels.nubefact.path' => 'string',
            'logging.channels.nubefact.level' => 'string',
            'logging.channels.nubefact.days' => 'integer',
            'logging.channels.nubefact.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
            ...
            'nubefact.base_url' => 'string',
            'nubefact.token' => 'string',
            'nubefact.timeout' => 'string',
            'nubefact.enviar_automaticamente_sunat' => 'boolean',
            'nubefact.enviar_automaticamente_cliente' => 'boolean',
            'nubefact.formato_pdf' => 'string',
            'nubefact.incluir_base64' => 'boolean',
            'nubefact.modo' => 'string',
            'nubefact.guias.max_reintentos_consulta' => 'integer',
            'nubefact.guias.segundos_entre_reintentos' => 'integer',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.minio.driver','filesystems.disks.minio.key','filesystems.disks.minio.secret',
...
'filesystems.disks.minio.throw','filesystems.disks.documentos.driver','filesystems.disks.documentos.key','filesystems.disks.documentos.secret','filesystems.disks.documentos.region',
'filesystems.disks.documentos.bucket','filesystems.disks.documentos.url','filesystems.disks.documentos.endpoint','filesystems.disks.documentos.use_path_style_endpoint','filesystems.disks.documentos.root',
'filesystems.disks.documentos.visibility','filesystems.disks.documentos.throw','filesystems.disks.comprobantes.driver','filesystems.disks.comprobantes.key','filesystems.disks.comprobantes.secret',
'filesystems.disks.comprobantes.region','filesystems.disks.comprobantes.bucket','filesystems.disks.comprobantes.url','filesystems.disks.comprobantes.endpoint','filesystems.disks.comprobantes.use_path_style_endpoint',
'filesystems.disks.comprobantes.root','filesystems.disks.comprobantes.visibility','filesystems.disks.comprobantes.throw','filesystems.disks.adjuntos.driver','filesystems.disks.adjuntos.key',
'filesystems.disks.adjuntos.secret','filesystems.disks.adjuntos.region','filesystems.disks.adjuntos.bucket','filesystems.disks.adjuntos.url','filesystems.disks.adjuntos.endpoint',
'filesystems.disks.adjuntos.use_path_style_endpoint','filesystems.disks.adjuntos.root','filesystems.disks.adjuntos.visibility','filesystems.disks.adjuntos.throw','filesystems.links.C:\\Plataforma_Op_Com_Facturacion_Elect\\backend\\public\\storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.nubefact.driver',
'logging.channels.nubefact.path','logging.channels.nubefact.level','logging.channels.nubefact.days','logging.channels.nubefact.replace_placeholders','mail.default',
...
'nubefact.base_url','nubefact.token','nubefact.timeout','nubefact.enviar_automaticamente_sunat','nubefact.enviar_automaticamente_cliente',
'nubefact.formato_pdf','nubefact.incluir_base64','nubefact.modo','nubefact.guias.max_reintentos_consulta','nubefact.guias.segundos_entre_reintentos',
...
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Plataforma_Op_Com_Facturacion_Elect.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'LOG_LEVEL','FILESYSTEM_DISK','MINIO_ENDPOINT','MINIO_ACCESS_KEY','MINIO_SECRET_KEY',
'MINIO_BUCKET','MINIO_REGION','MINIO_USE_PATH_STYLE_ENDPOINT','DB_CONNECTION','DB_HOST',
...
'AWS_BUCKET','AWS_ENDPOINT','AWS_USE_PATH_STYLE_ENDPOINT','MINIO_ENDPOINT','MINIO_ACCESS_KEY',
'MINIO_SECRET_KEY','MINIO_BUCKET','MINIO_REGION','NUBEFACT_BASE_URL','NUBEFACT_TOKEN',
'NUBEFACT_TIMEOUT','NUBEFACT_AUTO_SUNAT','NUBEFACT_AUTO_EMAIL','NUBEFACT_PDF_FORMAT','NUBEFACT_INCLUDE_BASE64',
'NUBEFACT_MODE','GOOGLE_APPLICATION_CREDENTIALS','VITE_APP_NAME',);
