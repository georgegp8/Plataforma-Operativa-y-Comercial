...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('facturacion')->group(function () {
        ...
        Route::get('/descargar/html/{id}', [FacturacionController::class, 'descargarHtml']);
    ...
    Route::prefix('v1')->group(function () {
        ...
        Route::post('empresas/{id}/logo', [EmpresaController::class, 'uploadLogo'])->middleware('role:admin');
        ...
        Route::patch('empresas/{id}/toggle-activo', [EmpresaController::class, 'toggleActivo'])->middleware('role:admin');
        Route::patch('empresas/{id}/cambiar-modo', [EmpresaController::class, 'cambiarModo'])->middleware('role:admin');
